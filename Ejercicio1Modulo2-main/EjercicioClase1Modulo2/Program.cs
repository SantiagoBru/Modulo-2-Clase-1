...
namespace EjercicioClase1Modulo2
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            var ejercicio1 = JsonSerializer.Deserialize<Ejercicio1>(dataEjercicio1);
            var ejercicio2 = JsonSerializer.Deserialize<List<Estadistica>>(dataEjercicio2);
            var ejercicio3 = JsonSerializer.Deserialize<Ejercicio3>(dataEjercicio3);
